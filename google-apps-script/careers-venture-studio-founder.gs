/**
 * Persist Foundry — Careers: Venture Studio Founder → Google Sheet
 *
 * Spreadsheet:
 * https://docs.google.com/spreadsheets/d/1SOGNAdL2NK7skMHio1AJS8f-RnLTwEzwKHEkkN5Bk3Y/
 *
 ...
 *      - Description: Careers Venture Studio Founder
 *      - Execute as: Me
 ...
 *      {"success":true,"service":"Persist Foundry Careers — Venture Studio Founder",...}
 ...
 *      VITE_CAREERS_VENTURE_STUDIO_SCRIPT_URL=https://script.google.com/macros/s/XXXX/exec
...
var SHEET_ID = '1SOGNAdL2NK7skMHio1AJS8f-RnLTwEzwKHEkkN5Bk3Y';
var HEADERS = [
  'Full Name',
  'Email',
  'LinkedIn',
...
function doGet(e) {
  ...
  return respond({
    success: true,
    service: 'Persist Foundry Careers — Venture Studio Founder',
...
function handleApplication(data) {
  ...
  sheet.appendRow([
    ...
    String(
      data.roleTitle || data['role-title'] || 'Venture Studio Founder',
    ).trim(),
    String(data.formId || data['form-id'] || 'venture-studio-founder').trim(),
...
function testAppend() {
  Logger.log(
    JSON.stringify(
      handleApplication({
        formType: 'Careers-Venture-Studio-Founder',
        ...
        roleTitle: 'Venture Studio Founder',
        formId: 'venture-studio-founder',
      }),
    ),
  );
}
