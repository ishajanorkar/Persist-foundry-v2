...
const PORTFOLIO_RAW = [
  {
    ...
    tag: 'Robotics',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/open-droids.png',
    logoWidth: 43.5,
        hoverColor: '#9E56EA',
  ...
  },
  {
    ...
    logo: '/assets/portfolio-color/bump.png',
    logoWidth: 73.3,
  ...
  },
  {
    ...
    tag: 'AI · Music',
    tags: ['ai', 'media'],
    logo: '/assets/portfolio-color/song-gpt.png',
    logoWidth: 41.1,
  ...
  },
  {
    ...
    tag: 'AI · Privacy',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/face-search-ai.png',
    logoWidth: 39.7,
        hoverColor: '#03348C',
  ...
  },
  {
    ...
    tag: 'Media',
    tags: ['media', 'studio'],
    logo: '/assets/portfolio-color/gif-studios.png',
    logoWidth: 40,
        hoverColor: '#DE6045',
  ...
  },
  {
    ...
    tag: 'AI · Wellness',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/clo-ai.png',
    logoWidth: 36.4,
        hoverColor: '#DC838E',
    url: 'https://clo.ai/',
    description:
  ...
  },
  {
    ...
    tag: 'Venture Studio',
    tags: ['studio', 'media'],
    logo: '/assets/portfolio-color/alphabetski.png',
    logoWidth: 49.8,
        hoverColor: '#27685B',
  ...
  },
  {
    ...
    tag: 'AI · Health',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/mend.png',
    logoWidth: 36.1,
        hoverColor: '#8537FE',
    url: 'https://mend.app/',
    description:
  ...
  },
  {
    ...
    tags: ['ai', 'media'],
    logo: '/assets/portfolio-color/chainreach.png',
    logoWidth: 40.2,
        hoverColor: '#CDA434',
  ...
  },
  {
    ...
    tag: 'AI · Video',
    tags: ['ai', 'media'],
    logo: '/assets/portfolio-color/deepvid-ai.png',
    logoWidth: 52.1,
        hoverColor: '#EC7467',
  ...
  },
  {
    ...
    tag: 'Design Studio',
    tags: ['studio'],
    logo: '/assets/portfolio-color/persist-designs.png',
    logoWidth: 35.2,
        hoverColor: '#3D2D58',
  ...
  },
  {
    ...
    tags: ['talent', 'media'],
    logo: '/assets/portfolio-color/flic.png',
    logoWidth: 66,
        hoverColor: '#A7003E',
    url: 'https://flic.app/',
    description:
  ...
  },
  {
    ...
    tag: 'Talent',
    tags: ['talent'],
    logo: '/assets/portfolio-color/swissmote.png',
    logoWidth: 36.6,
        hoverColor: '#C1282D',
  ...
  },
  {
    ...
    tag: 'Investment',
    tags: ['studio'],
    logo: '/assets/portfolio-color/vital-ventures.png',
    logoWidth: 65.5,
    logoClass: 'is-line-mark is-invert',
        hoverColor: '#B8975A',
  ...
  },
  {
    ...
    tag: 'Think Tank',
    tags: ['civic', 'studio'],
    logo: '/assets/portfolio-color/asi-house.png',
    logoWidth: 39.7,
    hoverColor: '#79378C',
  ...
  },
  {
    ...
    logo: '/assets/portfolio-color/socialverse.png',
    logoWidth: 60.7,
    hoverColor: '#411241',
  ...
  },
  {
    ...
    tag: 'Social · Rewards',
    tags: ['social', 'consumer'],
    logo: '/assets/portfolio-color/vible.png',
    logoWidth: 32.2,
    hoverColor: '#CA9305',
    url: 'https://vible.app/',
    description:
  ...
  },
  {
    ...
    tag: 'Competitions',
    tags: ['studio', 'civic'],
    logo: '/assets/portfolio-color/startupathon.png',
    logoWidth: 37.2,
    hoverColor: '#805DD8',
  ...
  },
  {
    ...
    tag: 'AI · Fitness',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/pumpgym.png',
    logoWidth: 76,
    logoClass: 'is-wordmark',
        hoverColor: '#1BAF99',
  ...
  },
  {
    ...
    tag: 'AI · Education',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/pracai.png',
    logoWidth: 40.9,
    hoverColor: '#6AD426',
  ...
  },
  {
    ...
    tag: 'AI · Companion',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/yumiko-ai.png',
    logoWidth: 92,
    logoClass: 'is-wordmark is-wordmark-wide is-invert',
    hoverColor: '#865CA3',
    url: 'https://yumiko.ai/',
    description:
  ...
  },
  {
    ...
    tag: 'Influencer Marketing',
    tags: ['media', 'ai'],
    logo: '/assets/portfolio-color/creatorships.png',
    logoWidth: 66.2,
  ...
  },
  {
    ...
    tag: 'AI · Video',
    tags: ['ai', 'media'],
    logo: '/assets/portfolio-color/shorts-lol.png',
    logoWidth: 37.7,
    hoverColor: '#093F89',
  ...
  },
  {
    ...
    tag: 'AI · Social',
    tags: ['ai', 'social'],
    logo: '/assets/portfolio-color/westx.png',
    logoWidth: 37.5,
        hoverColor: '#3D0F5A',
    url: 'https://westx.com/',
    description:
  ...
  },
  {
    ...
    tag: 'No-Code · AI',
    tags: ['ai', 'studio'],
    logo: '/assets/portfolio-color/vibescoded.png',
    logoWidth: 79.4,
        hoverColor: '#A3A342',
  ...
  },
  {
    ...
    tag: 'Workspace',
    tags: ['studio'],
    logo: '/assets/portfolio-color/collabio.png',
    logoWidth: 52.7,
        hoverColor: '#FFBE0B',
  ...
  },
  {
    ...
    tag: 'AI · Voice',
    tags: ['ai', 'consumer'],
    logo: '/assets/portfolio-color/hey-ova.png',
    logoWidth: 40.5,
  ...
  },
  {
    ...
    tag: 'Video Chat',
    tags: ['social', 'ai'],
    logo: '/assets/portfolio-color/soulmegle.png',
    logoWidth: 40.7,
        hoverColor: '#AA33FF',
  ...
  },
  {
    ...
    tag: 'Creator Economy',
    tags: ['media', 'social'],
    logo: '/assets/portfolio-color/game-of-creators.png',
    logoWidth: 32.8,
  ...
  },
  {
    ...
    tag: 'People Search',
    tags: ['ai', 'talent'],
    logo: '/assets/portfolio-color/linkgrid.png',
    logoWidth: 37,
    hoverColor: '#4507E6',
  ...
  },
  {
    ...
    tags: ['talent', 'ai'],
    logo: '/assets/portfolio-color/career-accelerator.png',
    logoWidth: 44.7,
        hoverColor: '#3E1379',
    url: 'https://persistventures.com/',
    description:
  ...
  },
  {
    ...
    tag: 'Film · Web3',
    tags: ['media', 'studio'],
    logo: '/assets/portfolio-color/ascension-studios.png',
    logoWidth: 47.3,
        hoverColor: '#9EFF3E',
  ...
  },
  {
    ...
    tag: 'Dating',
    tags: ['consumer', 'social'],
    logo: '/assets/portfolio-color/meme-mates.png',
    logoWidth: 40.5,
        hoverColor: '#653872',
  ...
  },
  {
    ...
    tag: 'Community',
    tags: ['social', 'civic'],
    logo: '/assets/portfolio-color/communion.png',
    logoWidth: 38.8,
        hoverColor: '#00AEEF',
  ...
  },
  {
    ...
    tag: 'Automation',
    tags: ['ai', 'studio'],
    logo: '/assets/portfolio-color/workplete.png',
    logoWidth: 44.9,
        hoverColor: '#D4822B',
  ...
  },
  {
    ...
    tag: 'Content Engine',
    tags: ['media', 'studio'],
    logo: '/assets/portfolio-color/cloutso.png',
    logoWidth: 41.2,
    hoverColor: '#FF8336',
  ...
  },
  {
    ...
    tag: 'Civic · Nonprofit',
    tags: ['civic'],
    logo: '/assets/portfolio-color/election-agency.png',
    logoWidth: 47.1,
    logoClass: 'is-invert',
        hoverColor: '#FC1723',
  ...
  },
  {
    ...
    tags: ['media', 'social'],
    logo: '/assets/portfolio-color/createathon.png',
    logoWidth: 40.5,
        hoverColor: '#7149D2',
  ...
  },
  {
    ...
    tag: 'Movement',
    tags: ['civic'],
    logo: '/assets/portfolio-color/america-house.png',
    logoWidth: 40.5,
        hoverColor: '#082954',
  ...
  },
  {
    ...
    tag: 'GIF Tools',
    tags: ['media', 'ai'],
    logo: '/assets/portfolio-color/gifmor.png',
    logoWidth: 40.8,
    hoverColor: '#CEFF5E',
