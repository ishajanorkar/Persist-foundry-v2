      ...
      <div className="footer-top">
        ...
        <div className="footer-brand-col">
          ...
          <div className="footer-socials">
            ...
            <a href="https://www.instagram.com/persistventures/" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.youtube.com/@persistventures" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="YouTube">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-nav-col">
          ...
          <nav className="footer-nav-links">
            ...
            <a href="#" className="footer-nav-link">Portfolio</a>
